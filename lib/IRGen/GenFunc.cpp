...
#include "swift/AST/ReferenceStorage.def"
  ...
  // class DifferentiableFuncTypeFieldInfo
  //     : public RecordField<DifferentiableFuncTypeFieldInfo> {
  // public:
  //   DifferentiableFuncTypeFieldInfo(unsigned index, const TypeInfo &type)
  ...
  //     : public RecordTypeInfo<DifferentiableFuncTypeFieldInfo>,
  //       public LoadableTypeInfo {
  // public:
  //   DifferentiableFuncTypeInfo(ArrayRef<DifferentiableFuncTypeFieldInfo> fields,
  //                              llvm::StructType *storageType, Size size, Alignment align,
  //                              const SpareBitVector &spareBits)
  //       : LoadableTypeInfo(storageType, size, spareBits, align, IsNotPOD /*???*/, IsFixedSize /*???*/) {}
  // };

  /// The differentiable function type-info class.
  // class DifferentiableFuncTypeInfo
